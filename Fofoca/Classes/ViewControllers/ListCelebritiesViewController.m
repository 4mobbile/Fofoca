//
//  ListCelebritiesViewController.m
//  Fofoca
//
...
#import "ListCelebritiesViewController.h"

@interface ListCelebritiesViewController ()

@end

@implementation ListCelebritiesViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    
    self.celebrities = [CelebrityModel parseCelebrities];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UILabel *celebrityName = (UILabel *)[cell viewWithTag:101];
